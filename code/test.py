...
# 2021-07-22, note this function is not actually used in the paper.
## revised for the model-level evaluation.
"""
# -*- coding: utf-8 -*-
...
def CNN(dataPath, bk_dataPath, modelSavePath, dataInfo, plotResult=False):
        ...
        binary_eval(gold_cnv, pred_cnv, "CNN_test"+ os.path.basename(modelSavePath))
        label_eval(gold_cnv, pred_cnv, rgs_cnv)
...
if  __name__ == "__main__":
        ...
        parser.add_argument('--dataSelect', '-d', type=str, default="na12878", required=True, help='sample1 name')
